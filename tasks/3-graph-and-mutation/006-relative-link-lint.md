...
Reuses the cross-bundle link-rewrite engine from move/rename (002); the `--fix` lives under [`check --fix`](/3-graph-and-mutation/007-check-fix.md). Keeps the graph root-absolute-only.
