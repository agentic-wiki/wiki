...
v1 embeds the starter in this repo (`internal/scaffold/files/`). Growing it into a self-contained operating manual (`AGENTS.md`) plus a selectable `--workflow`, and trimming the example, is [workflow scaffold](./005-workflow-scaffold.md).
